return {
	...
	["workshop-431003525"] = { enabled = true },  --"Saber Lion(P)"
	["workshop-437711916"] = { enabled = true },  --"Saber Lion(P)"
	["workshop-458587300"] = { enabled = true },  --"Fast Travel"
	["workshop-461627386"] = { enabled = true },  --"Madoka(P)"
	["workshop-482125281"] = { enabled = true },  --"Nico"
	["workshop-498729626"] = { enabled = true },  --"Annie(P) ===Silhcade Edition==="
	["workshop-540456786"] = { enabled = true },  --"Teto"
	["workshop-550193026"] = { enabled = true },  --"Kasen Ibaraki(P)"
